...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Netflix Admin Manager</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        @canany(['admin', 'productManager'])
          <li class="nav-item">
            <a class="nav-link" href="{{route('admin.films')}}">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
              </div>
              <span class="nav-link-text ms-1">Table Films</span>
            </a>
          </li>
        @endcanany
        @canany(['admin', 'timeManager'])
          <li class="nav-item">
            <a class="nav-link " href="{{route('release_date.index')}}">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa-regular fa-calendar-days  text-success text-sm opacity-10"></i>
              </div>
              <span class="nav-link-text ms-1">Release Date</span>
            </a>
          </li>
        @endcanany
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{route('admin.change_password')}}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-key text-dark text-sm opacity-10"></i>
            </div>
